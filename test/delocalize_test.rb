...
class DelocalizeActionViewTest < ActionView::TestCase
  ...
  test "don't display converted value if field has errors" do
  ...
  test "don't modify the attribute_before_type_cast unless it can be parsed to a number" do
    @product.price = 'abc123.00,00'
    assert_equal @product.price, 0.0
    assert_equal @product.price_before_type_cast, 'abc123.00,00'
  end
